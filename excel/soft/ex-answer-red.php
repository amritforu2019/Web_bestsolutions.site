                                ...
                                <table   border="0" align="center" cellpadding="0" cellspacing="1"
                                    ...
                                    <tr>
                                        <td height="252" bgcolor="#FFFFFF" >
                                            <div class="correct" align="center"><h3>Red CODE List <?php /*if (isset
 ($_GET['answer'])) {
...
<table>
   ...
   <div class="grid-container-code">
    ...
    $qry=mysqli_query($DB_LINK,"select * from tbl_new_sequence_red order by question asc");
    while ($row = mysqli_fetch_array($qry)) {

    ?>

     <?php if(sumDigits($row['question'])==$i) { ?>

     <div class="grid-item">
      <div  class=" random-bg-red " >
...
<script type="text/javascript">
 function highlightDivByText(text) {
  ...
  const divs = document.querySelectorAll('.random-bg-red');
 ...
 function resetStyle() {
  // Get all divs with class 'box'
  const divs = document.querySelectorAll('.highlight-red');
