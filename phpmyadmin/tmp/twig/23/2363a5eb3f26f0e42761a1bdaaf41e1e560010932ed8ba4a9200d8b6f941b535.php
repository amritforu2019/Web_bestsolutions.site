...
class __TwigTemplate_7286ca4cc034fe88bd28d6999ae373cb8467af80e9b0bcf52602dee2bba2dfb2 extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Index choice:");
        ...
        echo ">
                ";
        // line 44
        if (((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["index"] ?? null), "getChoice", [], "method", false, false, false, 44), "PRIMARY")) ||  !twig_get_attribute($this->env, $this->source, ($context["index"] ?? null), "hasPrimary", [], "method", false, false, false, 44))) {
            // line 45
            echo "                  <option value=\"PRIMARY\"";
            echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["index"] ?? null), "getChoice", [], "method", false, false, false, 45), "PRIMARY"))) ? (" selected") : (""));
            echo ">PRIMARY</option>
                ";
        }
        // line 47
        echo "                <option value=\"INDEX\"";
        echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["index"] ?? null), "getChoice", [], "method", false, false, false, 47), "INDEX"))) ? (" selected") : (""));
        echo ">INDEX</option>
                <option value=\"UNIQUE\"";
        // line 48
        echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["index"] ?? null), "getChoice", [], "method", false, false, false, 48), "UNIQUE"))) ? (" selected") : (""));
        echo ">UNIQUE</option>
                <option value=\"SPATIAL\"";
        // line 49
        echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["index"] ?? null), "getChoice", [], "method", false, false, false, 49), "SPATIAL"))) ? (" selected") : (""));
        echo ">SPATIAL</option>
                <option value=\"FULLTEXT\"";
        // line 50
        echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["index"] ?? null), "getChoice", [], "method", false, false, false, 50), "FULLTEXT"))) ? (" selected") : (""));
...
echo _gettext("Index type:");
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["index_type"]) {
            ...
            echo "\"";
            echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["index"] ?? null), "getType", [], "method", false, false, false, 92), $context["index_type"]))) ? (" selected") : (""));
            echo ">";
            echo twig_escape_filter($this->env, $context["index_type"], "html", null, true);
            echo "</option>
                ";
...
echo _gettext("Ignore");
            ...
            foreach ($context['_seq'] as $context["field_name"] => $context["field_type"]) {
                // line 170
                echo "                                    ";
                if ((((0 !== twig_compare(twig_get_attribute($this->env, $this->source, ($context["index"] ?? null), "getChoice", [], "method", false, false, false, 170), "FULLTEXT")) || twig_matches("/(char|text)/i",                 // line 171
$context["field_type"])) && ((0 !== twig_compare(twig_get_attribute($this->env, $this->source,                 // line 172
...
$context["field_type"], ($context["spatial_types"] ?? null))))) {
                    ...
                    echo "\"";
                    // line 176
                    if ((0 === twig_compare($context["field_name"], twig_get_attribute($this->env, $this->source, $context["column"], "getName", [], "method", false, false, false, 176)))) {
                        // line 177
            ...
            echo "                            </select>
                        ...
                        <td>
                            <input type=\"text\"
                                ...
                                value=\"";
            // line 191
            (((0 !== twig_compare(twig_get_attribute($this->env, $this->source,             // line 190
...
echo _gettext("Ignore");
                ...
                foreach ($context['_seq'] as $context["field_name"] => $context["field_type"]) {
                    ...
                    // line 211
                    echo "                                        <option value=\"";
                    echo twig_escape_filter($this->env, (((isset($context["col_index"]) || array_key_exists("col_index", $context))) ? (                    // line 212
...
";
    ...
    {
        return new Source("", "table/index_form.twig", "/home/bestsolutions/public_html/phpmyadmin/templates/table/index_form.twig");
    }
}
