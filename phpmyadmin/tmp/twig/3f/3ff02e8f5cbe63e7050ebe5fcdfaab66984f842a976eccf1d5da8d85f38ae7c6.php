...
/* home/index.twig */
class __TwigTemplate_94146df66241aceecf50b3dad99f1d011176b5f019838b85bea24e1a292aa8ba extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("License");
      ...
      ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["error"]) {
            ...
            echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["error"], "severity", [], "any", false, false, false, 278), "warning"))) ? ("alert-warning") : ("alert-info"));
            echo "\" role=\"alert\">
          ";
            // line 279
            if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["error"], "severity", [], "any", false, false, false, 279), "warning"))) {
                // line 280
                echo "            ";
...
";
    ...
    {
        return new Source("", "home/index.twig", "/home/bestsolutions/public_html/phpmyadmin/templates/home/index.twig");
    }
}
