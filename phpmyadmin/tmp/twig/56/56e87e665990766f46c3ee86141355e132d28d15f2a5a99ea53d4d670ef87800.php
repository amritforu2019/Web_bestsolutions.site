...
class __TwigTemplate_f7ca3bab8877b6acab2606ec2e4c0efc664d6ce9dc7fd5376f84e2686cb90629 extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("at beginning of table");
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["one_column_name"]) {
                ...
                echo "\"";
                // line 449
                echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["loop"], "revindex0", [], "any", false, false, false, 449), 0))) ? (" selected=\"selected\"") : (""));
                echo ">
                    ";
                // line 450
...
$context["index"], "getName", [], "method", false, false, false, 504)], "", false);
                ...
                <td rowspan=\"";
                  ...
                  ";
                    // line 510
                    if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["index"], "getName", [], "method", false, false, false, 510), "PRIMARY"))) {
                        // line 511
                        echo "                    ";
...
($context["index_params"] ?? null), ["db" => ($context["db"] ?? null), "table" => ($context["table"] ?? null)]), PhpMyAdmin\Html\Generator::getIcon("b_drop", _gettext("Drop")), ["class" => "drop_primary_key_index_anchor ajax"]);
                ...
                ";
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["column"]) {
                        // line 536
                        echo "                  ";
                        if ((1 === twig_compare(twig_get_attribute($this->env, $this->source, $context["column"], "getSeqInIndex", [], "method", false, false, false, 536), 1))) {
                            // line 537
                            echo "                    <tr class=\"noclick\">
                  ";
                        }
                  ...
                  ";
                        // line 549
                        if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["column"], "getSeqInIndex", [], "method", false, false, false, 549), 1))) {
                            // line 550
                            echo "                    <td rowspan=\"";
                            echo twig_escape_filter($this->env, ($context["columns_count"] ?? null), "html", null, true);
                            echo "\">";
...
";
        ...
        if (($context["have_partitioning"] ?? null)) {
            ...
            if (( !twig_test_empty(($context["partition_names"] ?? null)) &&  !(null === (($__internal_compile_50 = ($context["partition_names"] ?? null)) && is_array($__internal_compile_50) || $__internal_compile_50 instanceof ArrayAccess ? ($__internal_compile_50[0] ?? null) : null)))) {
                ...
                // line 584
                echo "        ";
                $context["range_or_list"] = ((((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["first_partition"] ?? null), "getMethod", [], "method", false, false, false, 584), "RANGE")) || (0 === twig_compare(twig_get_attribute($this->env, $this->source,                 // line 585
($context["first_partition"] ?? null), "getMethod", [], "method", false, false, false, 585), "RANGE COLUMNS"))) || (0 === twig_compare(twig_get_attribute($this->env, $this->source,                 // line 586
($context["first_partition"] ?? null), "getMethod", [], "method", false, false, false, 586), "LIST"))) || (0 === twig_compare(twig_get_attribute($this->env, $this->source,                 // line 587
...
";
    ...
    {
        return new Source("", "table/structure/display_structure.twig", "/home/bestsolutions/public_html/phpmyadmin/templates/table/structure/display_structure.twig");
    }
}
